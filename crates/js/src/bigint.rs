...
pub fn from_i64<'s>(scope: &'s Scope<'_>, num: i64) -> Result<Handle<'s, *mut BigInt>, ExnThrown> {
...
pub fn from_u64<'s>(scope: &'s Scope<'_>, num: u64) -> Result<Handle<'s, *mut BigInt>, ExnThrown> {
...
pub fn from_bool<'s>(scope: &'s Scope<'_>, b: bool) -> Result<Handle<'s, *mut BigInt>, ExnThrown> {
...
pub fn from_number<'s>(
    scope: &'s Scope<'_>,
    num: f64,
) -> Result<Handle<'s, *mut BigInt>, ExnThrown> {
...
pub fn to_string<'s>(
    ...
    radix: u8,
) -> Result<Handle<'s, *mut JSString>, ExnThrown> {
